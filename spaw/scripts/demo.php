...
$sw->show();
    ...
    $sw = new SPAW_Wysiwyg(
        'spaw2' /*name*/,
        isset($_POST['spaw2']) ? stripslashes($_POST['spaw2']) : '' /*value*/,
        'lt' /*language*/,
...
$sw->show();
    ...
    $sw = new SPAW_Wysiwyg(
        'spaw3' /*name*/,
        isset($_POST['spaw3']) ? stripslashes($_POST['spaw3']) : '' /*value*/,
        'en' /*language*/,
        'full' /*toolbar mode*/,
        'classic' /*theme*/,
        '550px' /*width*/,
...
$sw->show();
    ...
    $sw = new SPAW_Wysiwyg(
        'spaw4' /*name*/,
        isset($_POST['spaw4']) ? stripslashes($_POST['spaw4']) : '' /*value*/,
        'en' /*language*/,
        'mini' /*toolbar mode*/,
        '' /*theme*/,
        '250px' /*width*/,
...
$sw->show();
    ...
    $sw = new SPAW_Wysiwyg(
        'spaw5' /*name*/,
        isset($_POST['spaw5']) ? stripslashes($_POST['spaw5']) : '' /*value*/,
        'en' /*language*/,
        'mini' /*toolbar mode*/,
        '' /*theme*/,
        '250px' /*width*/,
        '90px' /*height*/,
        'scripts/demo_red.css' /*stylesheet file*/
    );
    $sw->show();
    ?>
    ...
    <hr width="100%" size="1">
    <h2>DEMO #6</h2>
    <p>There is a way to customize the content of the dropdowns like styles, fonts, etc. You can customize it for all instances of the control by modifying $spaw_dropdown_data array in config file or you can do it for all instances of control on the page by modifying same array but this time in your
        current script or you can specify specific data for dropdowns of one specific instance. This example show how...</p>
    <pre>
...
$sw->show();
    ...
    $sw = new SPAW_Wysiwyg(
        'spaw6' /*name*/,
        isset($_POST['spaw6']) ? stripslashes($_POST['spaw6']) : '' /*value*/,
        'en' /*language*/,
